...
function AboutMe() {
  return (
      <div className='body'>
          <article>
              <p className="AboutMe"><img className="Selfie" src="selfie.jpg"></img>My passion for technology began when I was little. I have been using computers since I was little
